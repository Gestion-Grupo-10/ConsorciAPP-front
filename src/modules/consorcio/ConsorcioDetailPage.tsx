        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
             ...
             <div className="text-right border-l pl-6">
                ...
                <p className="text-lg font-bold text-blue-600">${totalALiquidar.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
             </div>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1 container mx-auto py-6 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold text-orange-600">${(totalALiquidar - totalRecaudado).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <TabsContent value="reportes" className="bg-white border rounded-xl p-6 shadow-sm min-h-[400px]">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-slate-50 p-4 rounded-lg border">
                  ...
                  <p className="text-lg font-bold">${totalCommon.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                <div className="bg-slate-50 p-4 rounded-lg border">
                  <p className="text-[10px] text-slate-500 uppercase font-bold">Extraordinarios</p>
                  <p className="text-lg font-bold">${totalExtra.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                <div className="bg-slate-50 p-4 rounded-lg border">
                  <p className="text-[10px] text-slate-500 uppercase font-bold">Particulares</p>
                  <p className="text-lg font-bold">${totalParticular.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                  ...
                  <TableBody>
                    {settlementData.map((row) => (
                      <TableRow key={row.id}>
                        ...
                        <TableCell className="text-right whitespace-nowrap">${row.partCommon.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        <TableCell className="text-right whitespace-nowrap">${row.partExtra.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        <TableCell className="text-right whitespace-nowrap">${row.partParticular.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        ...
                        <TableCell className="text-right font-bold whitespace-nowrap">${row.totalUnidad.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        <TableCell className="text-right text-green-600 font-medium whitespace-nowrap">${row.totalPagado.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        <TableCell className={`text-right font-bold whitespace-nowrap ${row.saldo > 0 ? 'text-red-500' : 'text-slate-900'}`}>
                          ${row.saldo.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
